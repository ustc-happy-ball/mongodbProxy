...
type Response struct {
	...
	ResponseType RESPONSE_TYPE `protobuf:"varint,1,opt,name=responseType,proto3,enum=databaseGrpc.RESPONSE_TYPE" json:"responseType,omitempty"`
}
...
func (x *Response) GetResponseType() RESPONSE_TYPE {
	if x != nil {
		return x.ResponseType
	}
	return RESPONSE_TYPE_ADD_RESPONSE
}
...
type FindResponse struct {
	...
	Results        map[string]*anypb.Any `protobuf:"bytes,2,rep,name=results,proto3" json:"results,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *FindResponse) GetResults() map[string]*anypb.Any {
	if x != nil {
		return x.Results
	}
	return nil
...
var file_response_proto_rawDesc = []byte{
	...
	0x2f, 0x61, 0x6e, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4b, 0x0a, 0x08, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3f, 0x0a, 0x0c, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x54, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x64,
	...
	0x6e, 0x73, 0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0x0d, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x10, 0x0a, 0x0e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x10, 0x0a, 0x0e, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x80, 0x02, 0x0a, 0x0c, 0x46,
	0x69, 0x6e, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x45, 0x0a, 0x0e, 0x72,
	...
	0x70, 0x63, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x1a, 0x50, 0x0a, 0x0c, 0x52,
	...
	0x6e, 0x79, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x62, 0x06, 0x70,
...
var file_response_proto_goTypes = []interface{}{
	...
	nil,                    // 5: databaseGrpc.FindResponse.ResultsEntry
	(RESPONSE_TYPE)(0),     // 6: databaseGrpc.RESPONSE_TYPE
	(RESPONSE_STATUS)(0),   // 7: databaseGrpc.RESPONSE_STATUS
	(*anypb.Any)(nil),      // 8: google.protobuf.Any
}
var file_response_proto_depIdxs = []int32{
	6, // 0: databaseGrpc.Response.responseType:type_name -> databaseGrpc.RESPONSE_TYPE
	7, // 1: databaseGrpc.FindResponse.responseStatus:type_name -> databaseGrpc.RESPONSE_STATUS
	5, // 2: databaseGrpc.FindResponse.results:type_name -> databaseGrpc.FindResponse.ResultsEntry
	8, // 3: databaseGrpc.FindResponse.ResultsEntry.value:type_name -> google.protobuf.Any
